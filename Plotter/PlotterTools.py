...
outputLoc = '/home/daq/fnal_tb_18_11/LocalData/RECO/Plots/OldData_reanalyse_v8/'
doLanFit = True
doLanGausFit = False

Cut_forAmp = [] ## For parasitic TB: Data1
...
Vars = []
Vars.append(['amp[0]','CH0_amp',';Channel 0 amplitude; Yields',300,0,1000])
Vars.append(['amp[1]','CH1_amp',';Channel 1 amplitude; Yields',300,0,1000])
Vars.append(['amp[2]','CH2_amp',';Channel 2 amplitude; Yields',300,0,1000])
Vars.append(['amp[3]','CH3_amp',';Channel 3 amplitude; Yields',300,-10,500])

Vars.append(['baseline_RMS[0]','CH0_baselineRMS',';Channel 0 Baseline RMS; Yields',300,0,10])
Vars.append(['baseline_RMS[1]','CH1_baselineRMS',';Channel 1 Baseline RMS; Yields',300,0,10])
Vars.append(['baseline_RMS[2]','CH2_baselineRMS',';Channel 2 Baseline RMS; Yields',300,0,10])
Vars.append(['baseline_RMS[3]','CH3_baselineRMS',';Channel 3 Baseline RMS; Yields',300,0,10])
